...
class VideoProcess:
    ...
    def video_merger(self) -> str:
        try:
            ...
            logging.info(f"Speed factor is: {speed_factor}")
            ...
            logging.error(f"Error during merging the video: {e}")
            raise Exception(f"Error during merging the video.")