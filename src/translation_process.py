    ...
    def translation_package(self):
        ...
        if from_lang_installed and to_lang_installed:
            ...
            if from_lang and to_lang and from_lang.get_translation(to_lang):
                print(f"Translation package from {self.from_lang} to {self.to_lang} is already installed.")
                return from_lang.get_translation(to_lang)
        
        # If the package exists but is not installed
        print(f"Installing translation package from {self.from_lang} to {self.to_lang}...")
        ...
        if package_to_install is not None:
            ...
            print(f"Installed translation package from {self.from_lang} to {self.to_lang}.")
